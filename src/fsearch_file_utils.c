...
fsearch_file_utils_cmp_paths(const char *s1, const char *s2) {
    ...
    static const unsigned int next_state[] = {/* state    x    d    0    - */
                                              /* S_N */ S_N,
                                              S_I,
                                              S_Z,
                                              S_N,
    ...
    static const int result_type[] = {/* state   x/x  x/d  x/0  x/-  d/x  d/d  d/0  d/-
                                                 0/x  0/d  0/0  0/-  -/x  -/d  -/0  -/- */

                                      /* S_N */ CMP, CMP, CMP, CMP, CMP, LEN, CMP, CMP, CMP, CMP, CMP, CMP,
                                      CMP,           CMP, CMP, CMP,
                                      /* S_I */ CMP, -1,  -1,  CMP, +1,  LEN, LEN, CMP, +1,  LEN, LEN, CMP,
                                      CMP,           CMP, CMP, CMP,
                                      /* S_F */ CMP, CMP, CMP, CMP, CMP, LEN, CMP, CMP, CMP, CMP, CMP, CMP,
                                      CMP,           CMP, CMP, CMP,
    ...
    while ((diff = path_char_weight(c1) - path_char_weight(c2)) == 0 && c1 != '\0') {
